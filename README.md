...
React JS allows you to create reusable components that can accept data changes. It makes it so that you don't have to hard code things and your code can be much dryer and more efficient. 

1. Describe component state.

Component state is an object that holds information that may change over time. 

1. Describe props.

Props are the arguments that are passed into components in react.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

Side effects are things that affect something outside the scope of the current function. You use useEffect().
